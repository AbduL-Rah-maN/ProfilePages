...
export function EmployeeProfile() {
  ...
  const [employee, setEmployee] = useState({
    ...
    createdJobs: [
      ...
      { id: "2", title: "UX Designer", status: "Closed" },
    ]
  });
  ...
  const handleSave = () => {
    console.log("Saving employee profile:", employee);
    setOpen(false);
  };
      ...
      >
        ...
        <MenuItem>
          ...
          <FormControlLabel
            control={
              <Switch
                checked={employee.settings.receiveApplicationEmails}
                onChange={(e) => {
        ...
        <MenuItem>
          ...
          <FormControlLabel
            control={
              <Switch
                checked={employee.settings.darkMode}
                onChange={(e) => {
              ...
              {employee.createdJobs.map((job, index) => (
                <div key={job.id}>
                  ...
                  <Select
                    ...
                    label="Status"
                    value={job.status}
                    onChange={(e) => handleJobChange(index, "status", e.target.value)}
                    margin="dense"
                    sx={{ mb: 2 }}
                  >
