...
export function Profile() {
  ...
  const [profile, setProfile] = useState({
    ...
    email: "akshay.gore@example.com",
    phone: "+91 9876543210",  
    about:
      "Enthusiastic developer with a focus on building clean, scalable web applications...",
    experience: [
      {
        title: "Frontend Intern",
        company: "TechCorp",
        period: "Jan 2024 - Apr 2024",
        description: "Developed responsive UIs in React & Tailwind",
      },
    ],
    education: [
      {
